<?php
class ControllerCatalogTopCategory extends Controller {
	private $error = array();
	...
	protected function getList() {
		...
		$this->response->setOutput($this->load->view('catalog/topcategory_list', $data));
	}
	...
	protected function getForm() {
		...
		$this->response->setOutput($this->load->view('catalog/topcategory_form', $data));
	}
