...
class ModelSaleReturn extends Model {
	...
	public function getReturns($data = array()) {
		...
		if (!empty($data['filter_manufacturer'])) {
			$implode[] = "r.manufacturer = '" . $this->db->escape((string)$data['filter_manufacturer']) . "'";
		}
