...
class ModelSaleVoucher extends Model {
	public function addVoucher($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "voucher (code, from_name, from_email, to_name, to_email, voucher_theme_id, message, amount, status, date_added) VALUES('" . $this->db->escape((string)$data['code']) . "','" . $this->db->escape((string)$data['from_name']) . "','" . $this->db->escape((string)$data['from_email']) . "','" . $this->db->escape((string)$data['to_name']) . "','"
            . $this->db->escape((string)$data['to_email']) . "','" . (int)$data['voucher_theme_id'] . "','" . $this->db->escape((string)$data['message']) . "','" . (float)$data['amount'] . "','" . (int)$data['status'] . "', NOW())");
