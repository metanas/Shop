...
class ModelCatalogReview extends Model {
	public function addReview($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "review (author,product_id, text, rating, status, date_added) VALUES('" . $this->db->escape((string)$data['author']) . "','" . (int)$data['product_id'] . "','" . $this->db->escape(strip_tags((string)$data['text'])) . "','" . (int)$data['rating'] . "','" . (int)$data['status'] . "','" . $this->db->escape((string)$data['date_added']) . "')");
