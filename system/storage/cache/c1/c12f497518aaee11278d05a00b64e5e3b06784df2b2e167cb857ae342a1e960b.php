...
class __TwigTemplate_1732541474b71bcec3c72eb661d3e02d7b0ea72f0e9512642a6eb4ee6b9247c5 extends Twig_Template
{
...
\t\$.ajax({
\t\turl: 'index.php?route=extension/total/shipping/quote&language=";
        // line 42
...
\t\$.ajax({
\t\turl: 'index.php?route=extension/total/shipping/shipping&language=";
        // line 139
        echo (isset($context["language"]) ? $context["language"] : null);
        echo "',
\t\ttype: 'post',
...
\t\$.ajax({
\t\turl: 'index.php?route=extension/total/shipping/country&language=";
        // line 171
        echo (isset($context["language"]) ? $context["language"] : null);
...
";
    ...
    {
        return array (  310 => 199,  300 => 192,  291 => 186,  273 => 171,  238 => 139,  213 => 116,  205 => 114,  197 => 112,  195 => 111,  190 => 109,  172 => 94,  157 => 82,  114 => 42,  104 => 37,  96 => 34,  91 => 32,  81 => 25,  75 => 21,  69 => 20,  61 => 18,  53 => 16,  50 => 15,  46 => 14,  42 => 13,  36 => 10,  30 => 7,  23 => 3,  19 => 1,);
    }
}
...
/* $('#button-quote').on('click', function() {*/
/* 	$.ajax({*/
/* 		url: 'index.php?route=extension/total/shipping/quote&language={{ language }}',*/
/* 		type: 'post',*/
/* 		data: 'country_id=' + $('select[name=\'country_id\']').val() + '&zone_id=' + $('select[name=\'zone_id\']').val() + '&postcode=' + encodeURIComponent($('input[name=\'postcode\']').val()),*/
/* 		dataType: 'json',*/
/* 		beforeSend: function() {*/
...
/* $(document).delegate('#button-shipping', 'click', function() {*/
/* 	$.ajax({*/
/* 		url: 'index.php?route=extension/total/shipping/shipping&language={{ language }}',*/
/* 		type: 'post',*/
/* 		data: 'shipping_method=' + encodeURIComponent($('input[name=\'shipping_method\']:checked').val()),*/
/* 		dataType: 'json',*/
/* 		beforeSend: function() {*/
...
/* $('select[name=\'country_id\']').on('change', function() {*/
/* 	$.ajax({*/
/* 		url: 'index.php?route=extension/total/shipping/country&language={{ language }}&country_id=' + this.value,*/
/* 		dataType: 'json',*/
/* 		beforeSend: function() {*/
/* 			$('select[name=\'country_id\']').prop('disabled', true);*/
/* 		},*/
