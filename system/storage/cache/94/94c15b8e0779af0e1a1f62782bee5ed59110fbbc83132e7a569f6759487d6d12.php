...
class __TwigTemplate_69ce8e64f2c2c54e9550a79e9601811d4709ae7ed24f34c0be8a255bd7e844db extends Twig_Template
{
...
\t\$.ajax({
\t\turl: 'index.php?route=extension/total/voucher/voucher&language=";
        // line 16
...
";
    ...
    {
        return array (  52 => 16,  42 => 11,  35 => 9,  30 => 7,  23 => 3,  19 => 1,);
    }
}
...
/* $('#button-voucher').on('click', function() {*/
/* 	$.ajax({*/
/* 		url: 'index.php?route=extension/total/voucher/voucher&language={{ language }}',*/
/* 		type: 'post',*/
/* 		data: 'voucher=' + encodeURIComponent($('input[name=\'voucher\']').val()),*/
/* 		dataType: 'json',*/
/* 		beforeSend: function() {*/
