...
$_['text_checkout_payment_method']   ='Étape %s: Méthode de paiement';
$_['text_checkout_confirm']          ='Étape %s: Confirmer l`ordre';
$_['text_modify']                    ='Modifier et raquo';
$_['text_condition_general']         ='En creant un compte, vous acceptez les';
$_['text_condition']                 ='Conditions générales';
$_['text_politic']                   ='Politique de confidentialite';
$_['text_new_customer']              ='OU BIEN CREEZ UN COMPTE';
$_['text_login_customer']            ='CONNECTEZ-VOUS';
...
$_['text_description_password']      ='Utilisez au moins 8 caracteres';
...
$_['text_comments']                  ='Ajoutez des commentaires à propos de votre commande';
...
$_['text_payment_description']       ='%s tous les %d %s (s) pour %d paiement (s)';
