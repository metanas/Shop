...
$_['text_approval'] = '<p style="text-align: justify;">Bonjour <span style="text-transform: uppercase;">%s</span>! Merci de cliquer sur le lien ci-dessus pour valider votre compte:<br/> %s</p><br/> <p style="text-align: justify;">Avex votre compte, vous pouvez choisir vos artcles preféres pour votre prochains achats, créer votre agenda d\'adresse et veaucoup plus de chose.';
