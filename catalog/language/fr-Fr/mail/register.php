...
$_['text_approval'] = '<p style="text-align: justify;font-size:20px ">Bonjour <span style="text-transform: uppercase;">%s</span>! Merci de cliquer sur le lien ci-dessus pour valider votre compte:<br/> <a href="%s">%s</a></p><br/> <p style="text-align: justify;font-size:20px ">Avec votre compte, vous pouvez choisir vos articles preférés pour votre prochain achats, créer votre agenda d\'adresse et beaucoup plus de choses.';
