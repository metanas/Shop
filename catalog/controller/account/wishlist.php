    ...
    public function add()
    {
        ...
        if ($product_info) {
            if ($this->customer->isLogged()) {
                ...
                $json['total'] = ($this->model_account_wishlist->getTotalWishlist() == 0) ? "" : $this->model_account_wishlist->getTotalWishlist();
            } else {
                ...
                $json['total'] = (isset($this->session->data['wishlist']) ? count($this->session->data['wishlist']) : "");
            }
        }
