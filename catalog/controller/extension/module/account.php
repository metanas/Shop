...
class ControllerExtensionModuleAccount extends Controller
{
    public function index()
    {
        ...
        $data['wishlist'] = $this->url->link('account/wishlist', array('language' => $this->config->get('config_language')));
        $data['order'] = $this->url->link('account/order', array('language' => $this->config->get('config_language')));
        $data['return'] = $this->url->link('account/return', array('language' => $this->config->get('config_language')));
