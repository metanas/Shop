...
class ControllerProductProduct extends Controller
{
    ...
    public function index()
    {
        ...
        foreach ($product_similar as $result) {
            ...
            $colors = $this->model_catalog_product->getColorProduct($result['product_id']);
        ...
        if ($product_info) {
            ...
            $colors = $this->model_catalog_product->getColorProduct($this->request->get['product_id']);

            foreach ($colors as $color) {
                $product_colors[] = $color['color'];
            }
            $data['color'] = join(" & ", $product_colors);
...
//			}
    ...
    public function review()
    {
        ...
        $pagination->limit = 5;
        $pagination->url = $this->url->link('product/product/review', 'language=' . $this->config->get('config_language') . '&product_id=' . $this->request->get['product_id'] . '&page={page}');
